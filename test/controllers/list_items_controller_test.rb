...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference("ListItem.count") do
      post list_items_url, params: { list_item: { done: @list_item.done, due_date: @list_item.due_date, priority: @list_item.priority, title: @list_item.title, todo_id: @list_item.todo_id } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { done: @list_item.done, due_date: @list_item.due_date, priority: @list_item.priority, title: @list_item.title, todo_id: @list_item.todo_id } }
